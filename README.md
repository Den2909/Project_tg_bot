...
Проект использует следующие инструменты для проверки и форматирования кода:
- **Black**: Автоматическое форматирование кода (PEP 8).
- **Flake8**: Проверка стиля и синтаксиса.
- **Pylint**: Анализ кода на ошибки и сложность.
- **Mypy**: Статическая проверка типов.

Для запуска линтеров локально выполните:
```bash
./lint.sh
