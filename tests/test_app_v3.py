...
async def test_style_handler_no_photo(mock_bot, mock_message):
    ...
    with patch.object(mock_message, "answer", new=AsyncMock()) as mock_answer:
        ...
        mock_answer.assert_called_once_with(
            "Пожалуйста, отправьте изображение для стилизации."
        )
...
async def test_style_handler_with_photo(
    mock_pil_open, mock_to_tensor, mock_load_model, mock_bot, mock_message
):
